    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-start">
            <div class="col-md-12 ftco-animate text-center mb-5">
                <p class="breadcrumbs mb-0"><span class="mr-3"><a href="/index">主页 <i class="ion-ios-arrow-forward"></i></a></span> <span>职位</span></p>
                ...
                <form action="/doNewPost" class="p-5 bg-white">
                    ...
                    <div class="row form-group">
                        <div class="col-md-12 mb-3 mb-md-0">
                            ...
                            <input type="text" id="zzy" name="zzy" class="form-control" placeholder="例如:UI工程师">
                        </div>
                    </div>
                    ...
                    <div class="row form-group mb-5">
                        <div class="col-md-12 mb-3 mb-md-0">
                            ...
                            <input type="text" name="zmoney" id="zmoney" class="form-control" placeholder="例如:138****4881">
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-12 mb-3 mb-md-0">
                            <label for="option-job-type-1">
                                <input type="radio" id="zlx" name="zlx" value="1"> 全职
                            </label>
                        </div>
                        <div class="col-md-12 mb-3 mb-md-0">
                            <label for="option-job-type-2">
                                <input type="radio" id="zlx" name="zlx" value="2"> 兼职
                            </label>
                        </div>

                        <div class="col-md-12 mb-3 mb-md-0">
                            <label for="option-job-type-3">
                                <input type="radio" id="zlx" name="zlx" value="3"> 自由职业
                            </label></div>
                        <div class="col-md-12 mb-3 mb-md-0">
                            <label for="option-job-type-4">
                                <input type="radio" id="zlx" name="zlx" value="4"> 实习
                            </label>
                        </div>
                    ...
                    <div class="row form-group mb-4">
                        ...
                        <div class="col-md-12 mb-3 mb-md-0">
                            <input type="text" id="zlocation" name="zlocation" class="form-control" placeholder="例如:陕西西安">
                        </div>
                    </div>

                    <div class="row form-group mb-4">
                        <div class="col-md-12"><h3>公司名称</h3></div>
                        <div class="col-md-12 mb-3 mb-md-0">
                            <input type="text" id="zname" name="zname" class="form-control" placeholder="例如:字节">
                        </div>
                    </div>

                    <div class="row form-group">
                        <div class="col-md-12"><h3>职位描述</h3></div>
                        <div class="col-md-12 mb-3 mb-md-0">
                            <textarea name="ztext" class="form-control" id="ztext" cols="30" rows="5"></textarea>
                        </div>
                    </div>

                    <div class="row form-group">
                        <div class="col-md-12">
                            <input type="button" id="fb"  value="发布" class="btn btn-primary  py-2 px-5">
                        </div>
                    </div>
...
<script>
    $(function () {
        /*发布信息*/
         $("#fb").click(function () {
                var zzy1=$("#zzy").val()
             var zmoney1=$("#zmoney").val()
             var zlx1=$("#zlx").val()
             var zlocation1=$("#zlocation").val()
             var ztext1=$("#ztext").val()
                 var zname1  =$("#zname").val()
              $.get("doNewPost",{"zzy":zzy1,"zmoney":zmoney1,"zlx":zlx1,"zlocation":zlocation1,"ztext":ztext1,"zname":zname1},function (data) {
                      var ss=eval(data);
                      if(ss=="-1"){
                          //点击确定后执行方法
                          swal({
